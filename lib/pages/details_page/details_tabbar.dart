...
class DetailsTabbar extends StatelessWidget {
    ...
    return Provide<DetailsInfoProvide>(
      builder: (context,child,val){
        ...
        return Container(
          ...
          child: Row(
            children: <Widget>[
              _myTableBarLeft(context, isLeft),
              _myTableBarRight(context, isRight)
            ],
          ),
        );
      },
  ...
  //左侧tabbar
  Widget _myTableBarLeft(BuildContext context,bool isLeft){
    return InkWell(
      onTap: (){
  ...
  //右侧tabbar
  Widget _myTableBarRight(BuildContext context,bool isRight){
    return InkWell(
      onTap: (){
